...
function tempera_copyright() {
	global $temperas;
	echo '<div id="site-copyright">' . wp_kses_post( do_shortcode( $temperas['tempera_copyright'] ) ) . '</div>';
} // tempera_copyright()
...
*/
function tempera_wp_body_open() {
	do_action( 'wp_body_open' );
}
add_action( 'cryout_body_hook', 'tempera_wp_body_open', 5 );
