...
For current translation contributors, see https://translate.wordpress.org/projects/wp-themes/tempera
...
* Fixed tables borders option not working
...
* Fixed some font options getting unselected after saving options

= 1.7.1 =
* Added 'tempera_header_crop' filter for 'header' image size crop position attribute
